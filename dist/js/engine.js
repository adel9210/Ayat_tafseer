...
tafaser = {
    ...
    "russian": "русский (Russian) - Кулиев -ас-Саади"
};
...
function hilitePage(page, memorize) {
    ...
    var sura, aya, top, left, prev_top, prev_left, mgwidth, mgheight, twidth, ofwidth, ofheight, fasel_sura, page_top,
        page_sura_top, width, height, diff, hl_id, hilite_id;
...
$(function () {
    ...
    $("#share_fb").click(function () {
        var url = encodeURIComponent('https://quran.ksu.edu.sa/index.php?l=' + logha + '&c=5');
    ...
    $("#share_twt").click(function () {
        ...
        var url = _lang['sh_desc'] + ' : ' + encodeURIComponent('https://quran.ksu.edu.sa/index.php?l=' + logha);
...
(function ($) {
    $.srch = function (elements, keywords, filter, lookup) {
        ...
        if (!keywords.length) filter = function () {
            return false;
        }
